...
RESULTS_PATH <- 'data/simResults-sdFit-12-20230726.RData'
load(RESULTS_PATH)
...
```
    ...
    ## 4         1        12            0   mleInv 13176.73 15041.62 15026.65
    ## 5         1        12            0  mleInvS 13217.10 15041.62 15033.66
    ## 6         1        12            0 mleInvST 13093.25 15041.62 15025.22
    ##   point_runtime conf_int_runtime B.lower B.point B.upper
    ## 1  1.484632e-03      0.001484632      NA      NA      NA
    ## 2            NA      0.065085411     100     100     100
    ## 3  0.000000e+00      0.012043715     100     100     100
    ## 4  4.339218e-05      6.701310873     100     100     100
    ## 5  3.194809e-05      4.098660231     100     100     100
    ## 6  3.910065e-05      4.264181852     100     100     100
...
{
  RESULTS_PATH <- paste0("data/simResults-sdFit-",n.samples[iSample],"-20230726.RData")
  load(RESULTS_PATH)
...
```
    ...
    ## # A tibble: 225 × 6
    ## # Groups:   method, error_factor [45]
    ##    method error_factor n.samples point.pct_na lower.pct_na upper.pct_na
    ##    <chr>         <dbl>     <dbl>        <dbl>        <dbl>        <dbl>
    ##  1 MINMI           0          12       15103.       13714.       15368.
    ##  2 MINMI           0          24       15061.       14404.       15196.
    ##  3 MINMI           0          36       15037.       14607.       15129.
    ##  4 MINMI           0          48       15025.       14705.       15094.
    ##  5 MINMI           0          60       15025.       14771.       15080.
    ##  6 MINMI           0.5        12       15087.       13694.       15523.
    ##  7 MINMI           0.5        24       15041.       14365.       15374.
    ##  8 MINMI           0.5        36       15013.       14547.       15309.
    ##  9 MINMI           0.5        48       15015.       14646.       15289.
    ## 10 MINMI           0.5        60       15006.       14691.       15267.
    ## # … with 215 more rows
...
```
    ...
    ##   <chr>         <dbl>   <dbl> <dbl>        <dbl>       <dbl>
    ## 1 MINMI            12     203    63          199      0.0290
    ## 2 mleInv           12     214   179          182      0.0104
    ## 3 mleInvS          12     214   179          182      0.0105
    ## 4 mleInvST         12     214   179          182      0.0106
    ## 5 mleInvW          12     214   179          182      0.0105
    ## 6 mleInvWS         12     214   179          182      0.0107
    ## 7 mleInvWST        12     214   179          182      0.0112
    ## 8 UNci             12     214   179          182    NaN     
    ## 9 UNwald           12     214   179          182    323.
...
```
    ...
    ##   method    n.samples MSE_000  bias variance_000 avg_runtime
    ##   <chr>         <dbl>   <dbl> <dbl>        <dbl>       <dbl>
    ## 1 mleInv           24      89    73           84      0.0201
    ## 2 mleInvS          24      89    73           84      0.0203
    ## 3 mleInvST         24      89    73           84      0.0202
    ## 4 mleInvW          24      89    73           84      0.0198
    ## 5 mleInvWS         24      89    73           84      0.0233
    ## 6 mleInvWST        24      89    73           84      0.0202
    ## 7 UNci             24      89    73           84    NaN     
    ## 8 UNwald           24      89    73           84    247.    
    ## 9 MINMI            24      98    14           98      0.0531
...
```
    ...
    ##   method    n.samples MSE_000  bias variance_000 avg_runtime
    ##   <chr>         <dbl>   <dbl> <dbl>        <dbl>       <dbl>
    ## 1 mleInv           36      51    32           50      0.0297
    ## 2 mleInvS          36      51    32           50      0.0298
    ## 3 mleInvST         36      51    32           50      0.0304
    ## 4 mleInvW          36      51    32           50      0.0300
    ## 5 mleInvWS         36      51    32           50      0.0300
    ## 6 mleInvWST        36      51    32           50      0.0299
    ## 7 UNci             36      51    32           50    NaN     
    ## 8 UNwald           36      51    32           50    205.    
    ## 9 MINMI            36      65    -3           65      0.0772
...
```
    ...
    ##    <chr>      <dbl> <chr>      <dbl>
    ##  1 MINMI         12 MSE_000 203.    
    ##  2 MINMI         12 Bias     62.5   
    ##  3 MINMI         12 Var_000 199.    
    ##  4 MINMI         12 Runtime   0.0290
    ##  5 MINMI         24 MSE_000  97.7   
    ##  6 MINMI         24 Bias     13.6   
    ##  7 MINMI         24 Var_000  97.6   
    ##  8 MINMI         24 Runtime   0.0531
    ##  9 MINMI         36 MSE_000  64.9   
    ## 10 MINMI         36 Bias     -3.08  
    ## # … with 170 more rows
...
```
    ...
    ##        <dbl> <chr>  <chr>        <dbl>
    ##  1        12 MINMI  Coverage   96.2   
    ##  2        12 MINMI  Width    2103.    
    ##  3        12 MINMI  Runtime     0.0290
    ##  4        24 MINMI  Coverage   94.8   
    ##  5        24 MINMI  Width    1319.    
    ##  6        24 MINMI  Runtime     0.0531
    ##  7        36 MINMI  Coverage   96     
    ##  8        36 MINMI  Width    1086.    
    ##  9        36 MINMI  Runtime     0.0772
    ## 10        48 MINMI  Coverage   95.8   
    ## # … with 125 more rows
