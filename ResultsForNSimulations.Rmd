...
* Coverage probability of MINMI is better than MLE for low sample size - but intervals very wide!
...
1. Coverage Probability:
    ...
    2. UN-MLE methods have good coverage at moderate-large sample sizes (but not for small n)
...
3. Runtime
    1. MINMI takes longer! Although I was using B=100, might have been fairer to compare at B=100 instead of doing choose B first
